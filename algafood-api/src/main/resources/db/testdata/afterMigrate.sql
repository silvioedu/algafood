...
lock tables cidade write, cozinha write, estado write, forma_pagamento write, 
	...
	usuario_grupo write, restaurante_usuario_responsavel write, item_pedido write, 
	pedido write, foto_produto write, oauth_client_details write;
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (7, 'Bar do João', 6, 4, utc_timestamp, utc_timestamp, true, true);
...
(1, 'João da Silva', 'joao.ger@algafood.com.br', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com.br', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com.br', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com.br', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(6, 'Débora Mendonça', 'silvioedu+debora@gmail.com', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp),
(7, 'Silvio Silva', 'silvioedu+silvio@gmail.com', '$2y$12$so423BQZdis4.a5wjGDXu.Q1Z7cZGmURwY3kIgkLgab/EJLxhWxGK', utc_timestamp);
