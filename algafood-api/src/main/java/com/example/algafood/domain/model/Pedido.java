...
public class Pedido extends AbstractAggregateRoot<Pedido>{
	...
	private static final String MSG_STATUS_NAO_PODE_ALTERAR = "Status do pedido %s não pode ser alterado de %s para %s.";
    ...
    private void setStatus(StatusPedido novoStatus) {
    	if (getStatus().naoPodeAlterarPara(novoStatus)) {
			throw new NegocioException(String.format(MSG_STATUS_NAO_PODE_ALTERAR, getCodigo(),
